...
class ContentNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, content_id: Optional[Any] = None):
...
class CategoryNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, category_id: Optional[Any] = None):
...
class RoleNotFoundError(ResourceNotFoundError):
    ...
    def __init__(self, role_id: Optional[Any] = None):
...
class DatabaseError(CMSException):
    ...
    def __init__(self, message: str = "A database error occurred", operation: Optional[str] = None):
