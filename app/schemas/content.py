...
class ContentCreate(BaseModel):
    ...
    publish_at: datetime | None = Field(None, description="When the content should be published")
...
class ContentUpdate(BaseModel):
    title: str | None = Field(None, title="Updated Title", description="The updated title of the content.")
    body: str | None = Field(None, title="Updated Body", description="The updated body of the content.")
    slug: str | None = Field(
    ...
    meta_description: str | None = Field(None, title="Meta Description", description="SEO description for the content.")
    meta_keywords: str | None = Field(None, title="Meta Keywords", description="SEO keywords for the content.")
    status: ContentStatus | None = Field(None, title="Content Status", description="The updated status of the content.")
    publish_at: datetime | None = Field(None, description="When the content should be published")
...
class ContentResponse(BaseModel):
    ...
    updated_at: datetime = Field(
        ..., title="Updated At", description="The timestamp when the content was last updated."
    )
