...
def upgrade() -> None:
    ...
    op.alter_column("activity_logs", "timestamp", existing_type=postgresql.TIMESTAMP(), nullable=False)
    op.alter_column("activity_logs", "description", existing_type=sa.VARCHAR(), type_=sa.Text(), nullable=False)
    op.create_index(
        "idx_content_action_timestamp", "activity_logs", ["content_id", "action", "timestamp"], unique=False
    )
    ...
    op.alter_column("content", "title", existing_type=sa.VARCHAR(), nullable=False)
    op.alter_column("content", "body", existing_type=sa.TEXT(), nullable=False)
    ...
    op.alter_column("content", "slug", existing_type=sa.VARCHAR(), nullable=False)
    op.alter_column("content", "meta_title", existing_type=sa.VARCHAR(), type_=sa.Text(), existing_nullable=True)
    op.alter_column("content", "meta_keywords", existing_type=sa.VARCHAR(), type_=sa.Text(), existing_nullable=True)
    ...
    op.alter_column("notifications", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column("roles", "permissions", existing_type=sa.JSON(), type_=sa.VARCHAR(), existing_nullable=False)
    op.drop_index(op.f("ix_notifications_user_id"), table_name="notifications")
    op.drop_index(op.f("ix_notifications_status"), table_name="notifications")
    op.drop_index(op.f("ix_notifications_content_id"), table_name="notifications")
    op.alter_column("notifications", "created_at", existing_type=postgresql.TIMESTAMP(), nullable=True)
    op.alter_column(
        "notifications",
        "status",
        existing_type=postgresql.ENUM("UNREAD", "READ", name="notificationstatus"),
    ...
    op.alter_column("content", "meta_keywords", existing_type=sa.Text(), type_=sa.VARCHAR(), existing_nullable=True)
    op.alter_column("content", "meta_title", existing_type=sa.Text(), type_=sa.VARCHAR(), existing_nullable=True)
    op.alter_column("content", "slug", existing_type=sa.VARCHAR(), nullable=True)
    op.alter_column("content", "body", existing_type=sa.TEXT(), nullable=True)
    op.alter_column("content", "title", existing_type=sa.VARCHAR(), nullable=True)
    ...
    op.create_foreign_key(
        "activity_logs_user_id_fkey", "activity_logs", "users", ["user_id"], ["id"], ondelete="SET NULL"
    )
    ...
    op.alter_column("activity_logs", "description", existing_type=sa.Text(), type_=sa.VARCHAR(), nullable=True)
    op.alter_column("activity_logs", "timestamp", existing_type=postgresql.TIMESTAMP(), nullable=True)
